<template>
    <el-row>
        <el-col :span="24">
            ...
            >
                <el-radio :label="10" border>10 minutes ago</el-radio>
                <el-radio :label="15" border>15 minutes ago</el-radio>
                <el-radio :label="20" border>20 minutes ago</el-radio>
            </el-radio-group>
        </el-col>
    </el-row>
    ...
    <el-row :gutter="10">
        ...
        <el-col :span="18">
            ...
            >
                <el-table-column fixed prop="updated_at_formated" label="Update at" width="150">
                </el-table-column>
                <el-table-column prop="owner.login" label="Login" width="120"> </el-table-column>
                <el-table-column label="Quantity Files" width="120" prop="sum_files">
                </el-table-column>
                <el-table-column prop="created_at_formated" label="Created at" width="150">
                </el-table-column>
                <el-table-column name="file_types_column" label="Files" width="300">
